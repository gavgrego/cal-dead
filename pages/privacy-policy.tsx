...
const About: NextPage = () => {
  return (
    <Grid mx={16} my={32} justify="center">
      <Grid.Col sm={12} md={6}>
        <Text>
          Privacy Policy for GOLDENSTATEDEAD Privacy Policy Last updated:
          December 23, 2022 This Privacy Policy describes Our policies and
          ...
          Privacy Policy has been created with the help of the Privacy Policy
          Generator. Interpretation and Definitions Interpretation The words of
          ...
          plural. Definitions For the purposes of this Privacy Policy: Account
          means a unique account created for You to access our Service or parts
          of our Service. Company (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to GOLDENSTATEDEAD. Cookies are small files
          that are placed on Your computer, mobile device or any other device by
          a website, containing the details of Your browsing history on that
          website among its many uses. Country refers to: California, United
          ...
          duration of a page visit). Website refers to GOLDENSTATEDEAD,
          accessible from https://goldenstatedead.com You means the individual
          ...
          information may include, but is not limited to: Email address Usage
          ...
          about cookies on the Privacy Policies website article. We use both
          ...
          You with those services. Cookies Policy / Notice Acceptance Cookies
          ...
          It means that this information may be transferred to — and maintained
          ...
          Data, We cannot guarantee its absolute security. Children&apos;s
          Privacy Our Service does not address anyone under the age of 13. We do
          ...
          gavin@goldenstatedead.com Generated using Privacy Policies Generator
        </Text>
      </Grid.Col>
    </Grid>
  );
